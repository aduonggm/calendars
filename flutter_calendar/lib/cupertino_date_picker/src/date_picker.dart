...
import 'package:flutter_calendar/cupertino_date_picker/src/widget/only_lunar_widget.dart';
import 'package:flutter_calendar/cupertino_date_picker/src/widget/only_solar_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    switch (route.pickerMode) {
      ...
      case DateTimePickerMode.datetime:
        ...
        break;
      case DateTimePickerMode.only_solar:
        pickerWidget = OnlySolar(
          onMonthChangeStartWithFirstDate:
          route.onMonthChangeStartWithFirstDate,
          minDateTime: route.minDateTime,
          maxDateTime: route.maxDateTime,
        ...
        break;
      case DateTimePickerMode.only_lunar:
        pickerWidget = OnlyLunar(
          onMonthChangeStartWithFirstDate:
          route.onMonthChangeStartWithFirstDate,
          minDateTime: route.minDateTime,
          maxDateTime: route.maxDateTime,
